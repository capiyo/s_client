...
export const Register = () => {
    ...
    const onSubmit = (data) => {
        ...
        fetch("https://solvus-api-4.onrender.com/auth/register", {
            method: "POST",
    ...
    return (
        <div className='max-w-scren-2xl  h-screen w-scree  md:w-4/6 lg:w-1/2 container mt-2 mx-auto xl:px-24 px-4 '>
                ...
                <form onSubmit={handleSubmit(onSubmit)} >
                    <div className='flex flex-col lg:flex-row  gap-8'>
                        ...
                        <div className='w-full'>
                            ...
                            <div>
                                <label className='block mt-1 m-1 text-sm'>Username Name</label>
                              ...
                              <div>
                                <label className='block mt-2 m-1 text-sm'>Phone Number</label>
                                <input type='text' required {...register("phoneNumber")} placeholder='0704306867' 
                    ...
                    <div className='flex justify-center my-8'>
                        <button className='block bg-green-500 text-white text-md py-3 px-16 rounded-md'>Register</button>
                    </div>
                </form>
