                    ...
                    <div className='flex flex-col lg:flex-row  gap-8'>
                        ...
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <div>
                             ...
                             <div>
                                <label className='block m-1 text-md text-green-500'>Budget <span className='text-sm'>(in KSh)</span></label>
                                <input type='text' required {...register("budget")} placeholder='5000' 
                                className='border-b-2 border-green-500 create-job-input placeholder:text-xs md:placeholder:text-sm  rounded-xl'>

                                </input>
                            </div>
                            <div>
                                <label className='block m-1 text-md text-green-500'>Deadline</label>
                                <input type='text' required {...register("deadline")}
                                 placeholder='Today'
                                  className=' border-b-2 border-green-500 create-job-input placeholder:text-xs md:placeholder:text-sm rounded-xl'>
                              ...
                              <div>
                                <label className='block m-1 text-md text-green-500'>Location</label>
                            ...
                            <div>
                                <label className='block m-1 text-md text-green-500'>Description</label>
                                <textarea className='create-job-input placeholder:text-xs md:placeholder:text-sm rounded-xl border-b-2 border-green-500' rows={4}
                                 placeholder='Job Description and Requirements' required {...register("description")} />
                            </div>
                        </div>
                        </div>
