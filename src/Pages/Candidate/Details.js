...
export const Details= () => {
    ...
    const onSubmit = (data) =>{
        ...
        fetch("https://solvus-api-4.onrender.com/users/add-profile", {
            method: "POST",
    ...
    return (
        <div className='w-[400px]   h-[600px] overflow-y-auto  container mt-2 mx-auto xl:px-24 px-4 bg-green-100  rounded-xl  border-2 border-red-500 hover:border-red-800 '>
